package com.RahmanWare.twilio.service;

import com.RahmanWare.twilio.config.TwilioConfig;
import com.RahmanWare.twilio.dto.OtpStatus;
import com.RahmanWare.twilio.dto.PasswordResetRequestDto;
import com.RahmanWare.twilio.dto.PasswordResetResponseDto;
    ...
    public Mono<PasswordResetResponseDto> sendOTPForPasswordReset(PasswordResetRequestDto passwordResetRequestDto) {
        ...
        try {
            ...
            Message message = Message
                    ...
                    .create();
            otpMap.put(passwordResetResponseDto.getUserName,otp);
